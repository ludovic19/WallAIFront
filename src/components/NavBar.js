...
const NavBar = () => {
  ...
  return (
    ...
    <a href="/" onClick={logOut} className="font-inter front-medium bg-[#6469ff] text-white px-4 py-2 rounded-md">Log Out</a>
    <Link to="/home"><img src={logo} alt="logo" style={{width:"200px"}} className="object-contain sm:w-auto"/></Link>
